# CLAUDE.md — Constitución del Proyecto Anclora Nexus

Este archivo define las reglas duras, restricciones y criterios de validación para Claude Code en este proyecto. Estas reglas son **inmutables** durante la fase beta (Q1-Q2 2026).
...
- Todos los comandos `memanto` son comandos de shell. Ejecutalos en Bash.
...
└── CLAUDE.md           ← Este archivo (reglas duras)
```
