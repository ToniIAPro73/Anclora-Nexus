...
async def intelligence_info():
    ...
    return {
        ...
        "capabilities": {
            ...
            "notebooklm_notebook": "Anclora Nexus Territorial Brain",
            "notebooklm_notebook_id": "452e73bc-8c2a-42ec-a34f-d0219fc8995a",
        },
        "limits": {
...
async def get_territorial_insights(
    ...
    These insights are generated by Claude Code querying the NotebookLM
    "Anclora Nexus Territorial Brain" notebook via MCP, then stored in
    Supabase for the frontend dashboard to consume.
    ...
    try:
        ...
        return {
            "insights": insights,
            "count": len(insights),
            "notebook": "Anclora Nexus Territorial Brain",
            "timestamp": datetime.now(timezone.utc).isoformat(),
        }
    except Exception as e:
