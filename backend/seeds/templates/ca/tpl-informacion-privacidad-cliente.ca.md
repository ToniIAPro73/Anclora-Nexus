...
display_name: "Informació de privacitat del client"
...
storage_path: templates/ca/tpl-informacion-privacidad-cliente.ca.md
effective_from:
effective_until:
---

<!-- MACHINE TRANSLATED STUB — Requires human legal review before publication. -->
<!-- Source: tpl-informacion-privacidad-cliente.es.md v0.1.0 -->
<!-- Translation status: machine_translated — DO NOT PUBLISH without approval. -->

# Informació de privacitat del client

**Organisation:** {{ organization.legal_name }} · **Ref:** {{ deal.folder_reference }} · **Date:** {{ document.generated_at }}

---

> **⚠ TRANSLATION NOTICE:** This document is a machine-translated draft based on the Spanish canonical version (APE-PRIVACY-017). It has not been reviewed by a legal professional. Placeholders are identical to the Spanish source. Do not use for signing without human legal review and approval.
