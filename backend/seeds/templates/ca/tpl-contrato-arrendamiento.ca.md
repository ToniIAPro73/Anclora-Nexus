...
display_name: "Contracte d'arrendament d'habitatge"
...
storage_path: templates/ca/tpl-contrato-arrendamiento.ca.md
effective_from:
effective_until:
---

<!-- MACHINE TRANSLATED STUB — Requires human legal review before publication. -->
<!-- Source: tpl-contrato-arrendamiento.es.md v0.1.0 -->
...
> **⚠ TRANSLATION NOTICE:** This document is a machine-translated draft based on the Spanish canonical version (APE-LEASE-HOME-007). It has not been reviewed by a legal professional. Placeholders are identical to the Spanish source. Do not use for signing without human legal review and approval.
