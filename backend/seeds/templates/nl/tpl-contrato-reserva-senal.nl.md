...
display_name: "Reservation and Deposit Agreement"
...
storage_path: templates/nl/tpl-contrato-reserva-senal.nl.md
effective_from:
effective_until:
---

<!-- MACHINE TRANSLATED STUB — Requires human legal review before publication. -->
<!-- Source: tpl-contrato-reserva-senal.es.md v0.1.0 -->
...
> **⚠ TRANSLATION NOTICE:** This document is a machine-translated draft based on the Spanish canonical version (APE-SALE-RESERVE-004). It has not been reviewed by a legal professional. Placeholders are identical to the Spanish source. Do not use for signing without human legal review and approval.
