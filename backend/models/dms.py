...
class TemplateDocumentType(str, Enum):
    ...
    contrato_reserva_senal = "contrato_reserva_senal"
    ...
    kyc_identificacion_cliente = "kyc_identificacion_cliente"
    acuerdo_confidencialidad = "acuerdo_confidencialidad"
    hoja_visita = "hoja_visita"
    inventario_estado_inmueble = "inventario_estado_inmueble"
    informacion_privacidad_cliente = "informacion_privacidad_cliente"
    declaracion_origen_fondos = "declaracion_origen_fondos"
    generico = "generico"
