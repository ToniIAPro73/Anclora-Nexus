...
Fecha: `2026-05-05`
Estado: `ACTIVE`
Ámbito: futuras integraciones de acceso, invitación y UX relacionada con `anclora-synergi`
...
Este contrato sirve como referencia para cualquier feature de Nexus que afecte a Synergi, especialmente solicitudes de acceso, aprobación, invitación, onboarding y enlaces hacia la app.
...
Nexus no debe imponer su gramática INTERNAL a las pantallas públicas o autenticadas de Synergi. Solo debe enviar al usuario hacia una experiencia Synergi coherente con este contrato.

## Gate de aceptación

Una feature relacionada con Synergi no está lista si:
