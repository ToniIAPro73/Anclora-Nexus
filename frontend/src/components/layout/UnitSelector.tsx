...
const UNITS: { code: UnitSystem; labelKey: 'unitMetric' | 'unitImperial'; symbol: string }[] = [
  { code: 'metric', labelKey: 'unitMetric', symbol: 'm²' },
  { code: 'imperial', labelKey: 'unitImperial', symbol: 'sq ft' },
]
          ...
          >
            {UNITS.map((unit) => (
              ...
              >
                ...
                <span className="text-sm font-medium">{t(unit.labelKey)}</span>
                {unitSystem === unit.code && (
                  <motion.div
