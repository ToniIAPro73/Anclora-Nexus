...
const FIELD_I18N: Record<string, LangMap> = {
  ...
  // ── NDA ────────────────────────────────────────────────────────────────────
  "nda.duration_years":           { es: { label: "Duración del NDA (años)",       placeholder: "2" },                      ca: { label: "Durada del NDA (anys)",          placeholder: "2" },                     en: { label: "NDA duration (years)",        placeholder: "2" },                     de: { label: "NDA-Laufzeit (Jahre)",           placeholder: "2" } },
  "nda.penalty_amount":           { es: { label: "Penalización por incumplimiento NDA", placeholder: "15.000 €" },         ca: { label: "Penalització per incompliment NDA", placeholder: "15.000 €" },            en: { label: "NDA breach penalty",          placeholder: "€ 15,000" },              de: { label: "NDA-Vertragsstrafe",             placeholder: "15.000 €" } },
  // ── Delivery (entrega inmueble) ─────────────────────────────────────────────
  "delivery.datetime":            { es: { label: "Fecha y hora de entrega",        placeholder: "15/09/2026 a las 11:00" }, ca: { label: "Data i hora de lliurament",      placeholder: "15/09/2026 a les 11:00" }, en: { label: "Delivery date and time",      placeholder: "09/15/2026 at 11:00" },   de: { label: "Übergabedatum und -uhrzeit",     placeholder: "15.09.2026 um 11:00 Uhr" } },
  "delivery.observations":        { es: { label: "Observaciones de la entrega",    placeholder: "Entrega de llaves en notaría tras firma" }, ca: { label: "Observacions del lliurament", placeholder: "Lliurament de claus a notaria" }, en: { label: "Delivery observations",  placeholder: "Keys handed at notary after signing" }, de: { label: "Übergabehinweise",           placeholder: "Schlüsselübergabe beim Notar" } },
};

// ── Namespace fallback ─────────────────────────────────────────────────────────

const NS_LABEL: Record<WizardLang, Record<string, string>> = {
  es: { booking: "Reserva", delivery: "Entrega", inventory: "Inventario", keys: "Llaves", nda: "Acuerdo de confidencialidad", sof: "Origen de fondos", supply: "Suministros", tenancy: "Arrendamiento", deal: "Expediente", buyer: "Comprador", seller: "Vendedor", landlord: "Arrendador", tenant: "Arrendatario", guest: "Huésped", agent: "Agente", property: "Inmueble", organization: "Agencia", document: "Documento", party_1: "Parte 1", party_2: "Parte 2", mandate: "Encargo" },
  ca: { booking: "Reserva", delivery: "Lliurament", inventory: "Inventari", keys: "Claus", nda: "Acord de confidencialitat", sof: "Origen de fons", supply: "Subministraments", tenancy: "Arrendament", deal: "Expedient", buyer: "Comprador", seller: "Venedor", landlord: "Arrendador", tenant: "Arrendatari", guest: "Hoste", agent: "Agent", property: "Immoble", organization: "Agència", document: "Document", party_1: "Part 1", party_2: "Part 2", mandate: "Encàrrec" },
  en: { booking: "Booking", delivery: "Delivery", inventory: "Inventory", keys: "Keys", nda: "Confidentiality agreement", sof: "Source of funds", supply: "Utilities", tenancy: "Tenancy", deal: "File", buyer: "Buyer", seller: "Seller", landlord: "Landlord", tenant: "Tenant", guest: "Guest", agent: "Agent", property: "Property", organization: "Agency", document: "Document", party_1: "Party 1", party_2: "Party 2", mandate: "Mandate" },
  de: { booking: "Buchung", delivery: "Übergabe", inventory: "Inventar", keys: "Schlüssel", nda: "Vertraulichkeitsvereinbarung", sof: "Mittelherkunft", supply: "Versorgung", tenancy: "Mietverhältnis", deal: "Akte", buyer: "Käufer", seller: "Verkäufer", landlord: "Vermieter", tenant: "Mieter", guest: "Gast", agent: "Makler", property: "Immobilie", organization: "Agentur", document: "Dokument", party_1: "Partei 1", party_2: "Partei 2", mandate: "Auftrag" },
};
