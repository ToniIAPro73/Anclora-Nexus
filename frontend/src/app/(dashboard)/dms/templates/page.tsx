...
const TEMPLATE_TYPES: { value: TemplateDocumentType; label: string }[] = [
  ...
  { value: 'contrato_reserva_senal', label: 'Contrato de reserva / señal' },
  ...
  { value: 'kyc_identificacion_cliente', label: 'KYC - Identificación de cliente' },
  { value: 'acuerdo_confidencialidad', label: 'Acuerdo de confidencialidad' },
  { value: 'inventario_estado_inmueble', label: 'Inventario / estado del inmueble' },
  { value: 'hoja_visita', label: 'Hoja de visita' },
  { value: 'declaracion_origen_fondos', label: 'Declaración de origen de fondos' },
  { value: 'informacion_privacidad_cliente', label: 'Información de privacidad' },
